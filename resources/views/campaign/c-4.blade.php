                            ...
                            <div class="card mt-5">
                                <div class="card-inner card-inner p-0">
                                    <div class="top-btn-holder">
                                        ...
                                        <div class="step-holder">4/10</div>
                                    </div>
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title"><b>Summarize your campaign, this is the title shown
                                                    to influencers</b></h3>
                                        </div>
                                    </div>

                                    <form method="POST" action="{{ route('create.campaign', ['id' => 5]) }}"
                                        id="form">
                                        @csrf
                                        <div class="form-group mb-3">
                                            <input id="verification-code" type="text"
                                                class="form-control form-control-lg" name="product_summary" autofocus
                                                placeholder="E.g. Summer Product Line Launch" required>
                                        </div>
                                        <div class="form-group mb-3">
