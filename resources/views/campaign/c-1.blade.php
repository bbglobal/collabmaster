                            ...
                            <div class="card mt-5">
                                <div class="card-inner card-inner p-0">
                                    <div class="top-btn-holder">
                                        ...
                                        <div class="step-holder">1/10</div>
                                    </div>
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title"><b>What platform is this campaign for?</b></h3>
                                        </div>
                                    </div>

                                    <form method="POST" action="{{ route('create.campaign', ['id' => 2]) }}" id="form">
                                        @csrf
                                        <div class="form-group mb-3">
                                            <select class="input platform-dropdown" name="platform" required>
