                        ...
                        <div class="nk-content-wrap">
                            <div class="nk-block-head nk-block-head-lg">
                                <div class="nk-block-head-content text-center">
                                    <h2 class="hero-title-text">Hire Influencers</h2>
                                    <div class="text-gray-1 hero-subtitle">
                                        <p class="lead">Hire influencers to create unique content for your brand</p>
                                    </div>
                                </div>
                                ...
                                <div class="nk-block mb-3">
                                    <article class="entry">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <p class="text-gray p-0 m-0">Hire Influencers</p>
