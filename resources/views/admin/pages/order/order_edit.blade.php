          ...
          <form id="signupForm" action="{{route('admin.order.update')}}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input id="name" class="form-control" name="description" type="text" value="{{$order->description}}">
              ...
              <div class="mb-3">
                ...
                <input id="name" class="form-control" name="package_content_type" type="text" value="{{$order->package_content_type}}">
              ...
              <div class="mb-3">
                ...
                <input id="name" class="form-control" name="price" type="text" value="{{$order->price}}">
