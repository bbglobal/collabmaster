                        ...
                        <div class="nk-content-wrap">
                            <div class="nk-block-head nk-block-head-lg">
                                <div class="nk-block-head-content text-center">
                                    <h2 class="hero-title-text">Let’s Get You in Touch With the Right Person</h2>
                                </div>
                            </div><!-- .nk-block -->
                                            ...
                                            <div class="row g-4">
                                                <div class="col-md-6">
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label" for="type-general">A general
                                                            enquiry</label>
                                                    </div>
                                                </div><!-- .col -->
                                                <div class="col-md-6">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" name="type"
                                                            id="type-problem">
                                                        <label class="custom-control-label" for="type-problem">I have a problem
                                                            need help</label>
                                                    </div>
                                                </div><!-- .col -->
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label class="form-label"><span>Give us the details </span><em
                                                                class="icon ni ni-info text-gray"></em></label>
                                                        <p class="text-soft">If you’re experiencing a personal crisis, are
                                                            unable to cope and need support send message. We will always try to
                                                            respond to texters as quickly as possible.</p>
                                                        <div class="form-control-wrap">
                                                            <div class="form-editor-custom">
                                                                ...
                                                                <div class="form-editor-action">
                                                                    <a class="link collapsed" data-toggle="collapse"
                                                                        href="#filedown"><em class="icon ni ni-clip"></em>
                                                                        Attach file</a>
                                                                </div>
                                                            </div>
                                                        </div>
