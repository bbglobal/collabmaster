                            ...
                            <div class="card mt-5">
                                <div class="card-inner card-inner p-0">
                                    <div class="top-btn-holder">
                                        ...
                                        <div class="step-holder">2/9</div>
                                    </div>
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title"><b>Summarize yourself, this is your title shown on
                                                    your profile</b></h3>
                                        </div>
                                    </div>

                                    <a href="{{ route('create.page', ['id' => 1]) }}" class="top-btn-holder d-block">
                                    ...
                                    <form method="POST" action="{{ route('create.page', ['id' => 3]) }}" id="form">
                                        @csrf
                                        <div class="form-group mb-3">
                                            <input id="bio" type="text" class="form-control form-control-lg"
                                                name="bio" autofocus
                                                placeholder="E.g. Fitness Content Creator & Student Athlete" required>
                                        </div>
                                        <div class="form-group mb-3">
