                        ...
                        <div class="nk-content-wrap">
                            <div class="nk-block-head nk-block-head-lg">
                                <div class="nk-block-head-content text-center">
                                    <h1 class="hero-title">Free Instagram Engagement Rate Calculator</h1>
                                    <div class="text-gray-1 hero-subtitle">
                                        <p class="lead">Check any Instagram accounts engagement for free using our engagement
                                            rate calculator</p>
                                    </div>
                                    ...
                                    <div class="hero-holder">
                                        <div class="username-holder">
                                            ...
                                            <div class="username-btn">Check</div>
                                        </div>
                                    </div>
                            ...
                            <div class="nk-block">
                                <div class="report-holder">
                                    <div class="loading-screen" style="display: none;">
                                        <div class="loading-img"><em class="icon ni ni-loader ni-spin"></em></div>
                                        <div class="loading-txt">Generating Report</div>
                                    </div>

                                    <div class="report-left-holder">
                                        <img class="report-prof-pic"
                                            src="https://d5ik1gor6xydq.cloudfront.net/reports/1/16993326502810895.webp"
                                            alt="@therock profile picture">
                                        <div class="">
                                            <div class="report-username"><span id="prof-name">@therock</span>
                                                <img class="verified-badge" alt=""
                                                    src="assets/websiteImages/creatorMarketplace/verifiedBadge.svg">
                                            </div>
                                            <div class="report-prof-details">
                                                <div class="report-prof-detail">
                                                    <div class="report-prof-num">392.1m</div>
                                                    <div class="report-prof-title">Followers</div>
                                                </div>
                                                <div class="report-prof-detail">
                                                    <div class="report-prof-num">826</div>
                                                    <div class="report-prof-title">Following</div>
                                                </div>
                                                <div class="report-prof-detail">
                                                    <div class="report-prof-num">7.4k</div>
                                                    <div class="report-prof-title">Posts</div>
                                                </div>
                                            </div>
                                            <a class="report-btn btn"
                                                href="index-1.htm?utm_source=tool&amp;utm_medium=find_similar_influencers_btn&amp;utm_campaign=ig_engagement_calculator">Find
                                                Similar Influencers</a>

                                        </div>
                                    </div>
                                    <div class="report-right-holder">
                                        <div class="report-nums-holder">
                                            <div>
                                                <img class="report-img" src="assets/websiteImages/creatorMarketplace/tools/er.svg"
                                                    alt="thunder">
                                                <div class="report-num">0.30%</div>
                                                <div class="report-title">Engagement Rate</div>
                                            </div>

                                            <div>
                                                <img class="report-img" src="assets/websiteImages/creatorMarketplace/tools/likes.svg"
                                                    alt="heart">
                                                <div class="report-num">1.2m</div>
                                                <div class="report-title">Average Likes</div>
                                            </div>

                                            <div>
                                                <img class="report-img" src="assets/websiteImages/creatorMarketplace/tools/comment.svg"
                                                    alt="chat">
                                                <div class="report-num">11.5k</div>
                                                <div class="report-title">Average Comments</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="cta-holder">
                                                <div class="cta-overlay-holder">
                                                    <div class="cta-txt-holder">
                                                        <h2 class="cta-title text-white">Find High Engagement Instagram
                                                            Influencers</h2>
                                                        <h3 class="cta-txt text-white">Hire top Instagram influencers in
                                                            Seconds. Get thumb-stopping content on demand.</h3>
                                                        <div class="btn cta-btn font-100 py-3 px-4 mt-2">Browser Influencers
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="nk-block nk-block-lg mb-5 pb-5">
                                ...
                                <div class="row p-0 m-0">
                                    <a href="#" class="other-links-combo-holder col-sm-6 col-md-4 col-lg-4">Find
                                        Lifestyle Instagram</a>
                                    <a href="#" class="other-links-combo-holder col-sm-6 col-md-4 col-lg-4">Find Fashion
                                        Instagram</a>
                                    <a href="#" class="other-links-combo-holder col-sm-6 col-md-4 col-lg-4">Find Beauty
                                        Instagram</a>
                                    <a href="#" class="other-links-combo-holder col-sm-6 col-md-4 col-lg-4">Find Travel
                                        Instagram</a>
                                    <a href="#" class="other-links-combo-holder col-sm-6 col-md-4 col-lg-4">Find Health
                                        &amp; Fitness Instagram</a>
                                    <a href="#" class="other-links-combo-holder col-sm-6 col-md-4 col-lg-4">Find Comedy
                                        &amp; Entertainment Instagram</a>
                                    <a href="#" class="other-links-combo-holder col-sm-6 col-md-4 col-lg-4">Find Food
                                        &amp; Drink Instagram</a>
                                </div>
                            </div>
                                        ...
                                        <div class="cta-holder">
                                            <div class="cta-overlay-holder">
                                                <div class="cta-txt-holder">
                                                    ...
                                                    <h3 class="cta-txt text-white">Search top Instagram, TikTok, and YouTube
                                                        influencers.</h3>
                                                    <div class="btn cta-btn font-100 py-3 px-4 mt-2">Browser Influencers</div>
                                                </div>
                                            </div>
                                            <img loading="lazy" alt="top influencers" class="cta-img"
                                                src="public/images/cta.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
