                                ...
                                <div class="card-inner card-inner p-0">
                                    ...
                                    <div class="nk-block-head my-4">
                                        <div class="nk-block-head-content w-75 mx-auto">
                                            <div class="d-flex"
                                                style="padding: 5px 5px; border: 1px solid; border-radius:4px; cursor: pointer;">
                                    ...
                                    @endif
                                    <form method="POST" action="{{ route('brand.register') }}" id="signup-form">
                                        @csrf
                                        ...
                                        <div class="form-group mb-3">
                                            <input id="brand_name" type="text"
                                                ...
                                                name="brand_name" value="{{ old('brand_name') }}" autofocus
                                        ...
                                        <div class="form-group mb-3">
                                            <select name="found_us" id="found_us"
                                                class="form-control form-select form-control-lg p-1 @error('found_us') is-invalid @enderror">
                                        ...
                                        <div class="form-group mb-3">
                                            <button class="btn btn-lg btn-secondary btn-block" id="primary">Sign
                                                Up</button>
                                    ...
                                    <div class="login-forgot forgot w-100 text-center my-4">By signing up,
                                        you agree to our <a class="text-dark" href="#">Terms</a> and
                                        <a href="#" class="text-dark">Privacy Policy</a>.
                                    </div>
                                    <div class="login-forgot forgot w-100 text-center my-4">lready have an
                                        account? <a href="login.html">Login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
