                        ...
                        <div class="nk-content-wrap">
                            <div class="nk-block-head nk-block-head-lg">
                                <div class="nk-block-head-content text-center">
                                    <h1 class="hero-title">Free Influencer Campaign Brief Template</h1>
                                    <div class="text-gray-1 hero-subtitle">
                                        <p class="lead">Generate influencer campaign briefs and share them for free</p>
                                    </div>
                                    <div>
                                        <button class="btn btn-dark btn-sign-up font-w-300 font-135">Create Compaign
                                            Brief</button>
                                    </div>
                                </div>
                            ...
                            <div class="nk-block">
                                <div class="camp-hero-holder">
                                    <div class="camp-hero-img-holder">
                                        <picture>
                                            <source media="(max-width: 800px)"
                                                srcset="assets/websiteImages/creatorMarketplace/brandPage/templateSmall.png">
                                            <img src="assets/websiteImages/creatorMarketplace/brandPage/template.png"
                                                alt="Influencer campaign brief" loading="lazy">
                                        </picture>
                                    </div>
                                ...
                                <div class="row p-0 m-0 my-5 row-reverse">
                                    <div class="col-sm-12 col-md-6 col-lg-6 mb-4 pr-md-5">
                                        <div class="example-steps-holder">
                                            <h2 class="example-row-title">Find and Hire Influencers in Seconds on the
                                                Marketplace</h2>

                                            <div class="example-step">
                                                <h3 class="example-step-title">Search Influencers</h3>
                                                <div class="example-step-txt">Search thousands of vetted Instagram, TikTok, and
                                                    YouTube influencers.</div>
                                            </div>
                                            <div class="example-step">
                                                <h3 class="example-step-title">Purchase Securely</h3>
                                                <div class="example-step-txt">Safely purchase through Collabstr. We hold your
                                                    payment until the work is completed.</div>
                                            </div>
                                            <div class="example-step">
                                                <h3 class="example-step-title">Receive Quality Content</h3>
                                                <div class="example-step-txt">Receive your high-quality content from influencers
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 mb-4">
                                        <picture>
                                            <source media="(max-width: 800px)"
                                                srcset="assets/websiteImages/creatorMarketplace/brandPage/marketplaceSmall.png">
                            ...
                            <div class="nk-block mb-5">
                                <div class="row p-0 m-0 my-5">
                                    <div class="col-sm-12 col-md-6 col-lg-6 mb-5">
                                        <picture>
                                            <source media="(max-width: 800px)"
                                                srcset="assets/websiteImages/creatorMarketplace/brandPage/campaignSmall.png">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 mb-5 px-md-5">
                                        <div class="example-steps-holder">
                                            <h2 class="example-row-title">Save Hours With Campaigns and Work With Influencers at
                                                Scale</h2>
                                ...
                                <div class="row p-0 m-0 my-5 row-reverse">
                                    <div class="col-sm-12 col-md-6 col-lg-6 mb-4 pr-md-5">
                                        <div class="example-steps-holder">
                                            ...
                                            <div class="example-step">
                                                <h3 class="example-step-title">Receive Quality Content</h3>
                                                <div class="example-step-txt">Receive your high-quality content from
                                                    influencers
                                                    directly through the platform.</div>
                                            </div>
                                        </div>
                            ...
                            <div class="nk-block mb-5">
                                <div class="row p-0 m-0 my-5">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 mb-5 px-md-5">
                                        <div class="example-steps-holder">
                                            <h2 class="example-row-title">Save Hours With Campaigns and Work With Influencers
                                                at Scale</h2>
                                        ...
                                        <div class="cta-holder">
                                            <div class="cta-overlay-holder">
                                                <div class="cta-txt-holder">
                                                    <h2 class="cta-title text-white">Find and Hire Influencers for Your
                                                        Campaign</h2>
                                                    <h3 class="cta-txt text-white">Find and hire top TikTok, Instagram, and
                                                        YouTube influencers for your campaign.</h3>
                                                    <div class="btn cta-btn font-100 py-3 px-4 mt-2">Get Started</div>
                                                </div>
                                            </div>
